...
static int module_create_renderer(int window_id) {
    ...
    if (!win) {
        puts("Error: Invalid window handle passed");
        return 0;
    }
...
static void module_run_loop(int renderer_id) {
    ...
    if (!renderer) {
        puts("Error: Invalid renderer handle passed");
        return;
    }
...
static const paw_ffi_function_t functions[] = {
    ...
    {
        .name = "create_window",
        .address = (void *)module_create_window,
        .return_type = PAW_FFI_INT,
        .arg_count = 3,
        .args = { PAW_FFI_CSTRING, PAW_FFI_INT, PAW_FFI_INT },
        .variadic = 0
    },
    {
        .name = "create_renderer",
        .address = (void *)module_create_renderer,
        .return_type = PAW_FFI_INT,
        .arg_count = 1,
        .args = { PAW_FFI_INT },
        .variadic = 0
    ...
    {
        .name = "destroy_window",
        .address = (void *)module_destroy_window,
        .return_type = PAW_FFI_VOID,
        .arg_count = 1,
        .args = { PAW_FFI_INT },
        .variadic = 0
    },
    {
        ...
        .address = (void *)module_destroy_renderer,
        .return_type = PAW_FFI_VOID,
        .arg_count = 1,
        .args = { PAW_FFI_INT },
        .variadic = 0
